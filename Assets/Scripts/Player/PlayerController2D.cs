...
public class PlayerController2D : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // glide: either external ability or (legacy) user hold W
        bool legacyHoldW = Keyboard.current != null && Keyboard.current.wKey.isPressed;
        isGliding = externallyControlledGlideActive || (
            !isGrounded &&
            !IsTouchingWall() &&
